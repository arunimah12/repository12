...
public class DatadrivenTesting2 {
	...
	{
		FileInputStream f=new FileInputStream("D:\\Sept30BatchPrograms-master\\SeleniumWebdriver\\src\\com\\qedge\\excelfiles\\registration.xlsx");
	
		//D:\Sept30BatchPrograms-master\SeleniumWebdriver\src\com\qedge\excelfiles\registration.xlsx
		...
		FileOutputStream f1=new FileOutputStream("D:\\registration.xlsx");
		wb.write(f1);
		f1.close();
	}
